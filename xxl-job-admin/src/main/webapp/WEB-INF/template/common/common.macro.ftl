	...
	<aside class="main-sidebar">
		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu">
                ...
                <li class="nav-click <#if pageName == "help">active</#if>" ><a href="${request.contextPath}/toArticleCount"><i class="fa fa-circle-o text-gray"></i><span>${I18n.jobinfo_baijia}</span></a></li>
			</ul>
		</section>
		<!-- /.sidebar -->
	</aside>
